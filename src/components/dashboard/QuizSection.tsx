...
export default function QuizSection() {
  ...
  useEffect(() => {
    ...
    const timer = setInterval(() => {
      ...
      setTimeToNextHeart(`${minutes.toString().padStart(2, '0')}:${seconds.toString().padStart(2, '0')}`);
    }, 1000);
  ...
  const allQuizzes: QuizQuestion[] = [
    {
      ...
      options: ["array.push()", "array.pop()", "array.unshift()", "array.shift()"],
      correctAnswer: 0,
      category: "JavaScript",
      difficulty: "Easy",
      xpReward: 15,
    ...
    },
    {
      ...
      difficulty: "Medium",
      xpReward: 20,
      explanation: "Django is a high-level Python web framework that encourages rapid development and clean, pragmatic design. It's not a JavaScript framework."
    },
    {
      id: 4,
    ...
    },
    {
      ...
      difficulty: "Medium",
      xpReward: 20,
      explanation: "The valid CSS position properties are static, relative, absolute, fixed, and sticky. There is no 'floating' position property."
    },
    {
      id: 6,
    ...
    },
    {
      ...
      options: ["How elements are displayed on a page", "How margins and padding interact", "The content, padding, border, and margin areas", "How flexbox works"],
      correctAnswer: 2,
      category: "CSS",
      difficulty: "Medium",
      xpReward: 20
    ...
    {
      id: 8,
      question: "Which is the correct JavaScript syntax to declare a constant?",
  ...
  useEffect(() => {
    if (selectedCategory === "All") {
      ...
      const filtered = allQuizzes.filter(quiz => quiz.category === selectedCategory);
      setQuizzes(filtered);
    }
    setCurrentQuiz(0);
  ...
  const getDifficultyColor = (difficulty: string) => {
    switch (difficulty) {
      case "Easy": return "text-[#58c896]";
      case "Medium": return "text-[#fab72b]";
      case "Hard": return "text-[#ff5e7d]";
      default: return "text-[#58c896]";
    }
  };
      ...
      <div className="bg-dark-300/30 backdrop-blur-sm border border-white/5 rounded-xl overflow-hidden">
        <div className="p-5 border-b border-white/5 flex justify-between items-center">
          <h2 className="text-xl font-bold text-white flex items-center">
            <svg className="w-5 h-5 mr-2 text-[#ff5e7d]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="p-5">
          <div className="flex flex-col items-center justify-center py-6">
            ...
            <h3 className="text-2xl font-bold text-white mb-2">Out of Hearts</h3>
            <p className="text-gray-400 text-center mb-6">
              You've run out of hearts! Wait for hearts to refill or get more hearts to continue your quiz.
            </p>
            ...
            {timeToNextHeart && (
              <div className="bg-dark-200/50 rounded-lg p-4 flex flex-col items-center w-full mb-6">
                ...
                <div className="text-[#ff5e7d] text-2xl font-bold">{timeToNextHeart}</div>
                <p className="text-gray-400 text-xs mt-2">1 heart refills every hour</p>
              </div>
            )}
        ...
        <div className="p-5">
          <div className="flex flex-col items-center justify-center py-6">
            <div className="w-24 h-24 rounded-full bg-[#8e5ff5]/20 flex items-center justify-center mb-4">
              <svg className="w-12 h-12 text-[#8e5ff5]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 1 1-14 0c0-1.153.433-2.294 1-3a2.5 2.5 0 0 0 2.5 2.5z" />
              </svg>
            </div>
              ...
              <div className="bg-dark-200/50 rounded-lg px-3 py-2 flex items-center">
                <div className="flex mr-2">
                  {[...Array(maxHearts)].map((_, i) => (
                    <svg
                      key={i}
                      className={`w-5 h-5 ${i < hearts ? 'text-[#ff5e7d]' : 'text-gray-600'}`}
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      fill="currentColor"
                    >
                ...
                <span className="text-white font-medium text-sm">{hearts} hearts remaining</span>
              </div>
            </div>
            ...
            <div className="flex flex-col w-full space-y-4 mb-6">
              <div className="bg-dark-200/50 rounded-lg p-4 flex justify-between items-center">
                ...
                <div className="text-[#8e5ff5] font-bold">{correctStreak} correct</div>
              </div>
              ...
              {correctStreak >= 3 && (
                <div className="bg-dark-200/50 rounded-lg p-4 flex justify-between items-center">
                  ...
                  <div className="text-[#58c896] font-bold">+{Math.min(correctStreak, 5) * 2} XP</div>
                </div>
              )}
            </div>
            ...
            {correctStreak >= 5 && (
              <div className="mt-4 p-3 bg-[#58c896]/10 border border-[#58c896]/30 rounded-lg flex items-center">
                <div className="h-8 w-8 rounded-full bg-[#58c896]/20 flex items-center justify-center mr-3 flex-shrink-0">
                  <svg className="w-4 h-4 text-[#58c896]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M20 6 9 17l-5-5" />
                  </svg>
                </div>
                <div>
                  <p className="text-[#58c896] font-medium">Achievement Progress</p>
                  <p className="text-gray-400 text-xs">
                    You're making progress toward the 'Quiz Master' achievement!
                  </p>
                </div>
              </div>
            )}
  ...
  return (
    <div className="bg-dark-300/30 backdrop-blur-sm border border-white/5 rounded-xl overflow-hidden relative">
        ...
        <div className="flex items-center">
          <div className="flex mr-3">
            ...
            {hearts < maxHearts && timeToNextHeart && (
              <span className="text-xs text-[#58c896] ml-1">{timeToNextHeart}</span>
            )}
          </div>
        ...
        <div className="px-5 pt-3 flex items-center">
          <div className="flex-1 flex items-center">
            <div className="h-5 w-5 rounded-full bg-[#ff5e7d]/20 flex items-center justify-center mr-2">
              <svg className="w-3 h-3 text-[#ff5e7d]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="flex">
            {Array.from({ length: Math.min(correctStreak, 5) }).map((_, i) => (
              <div key={i} className="h-4 w-4 ml-1">
                <svg className="w-full h-full text-[#ff5e7d]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                  <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
                </svg>
              </div>
            ))}
            {correctStreak > 5 && (
              <span className="text-xs text-[#ff5e7d] ml-1 font-medium">+{correctStreak - 5}</span>
            )}
          </div>
        </div>
      )}
      ...
      <div className="p-5">
        <div className="flex flex-wrap justify-between items-center mb-5">
          <div className="bg-dark-200 rounded-full px-3 py-1 text-xs text-gray-300 flex items-center mb-2 sm:mb-0">
            <svg className="w-3 h-3 mr-1 text-[#8e5ff5]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="mb-5">
          <h3 className="text-white text-lg font-medium mb-5">{currentQuestion?.question}</h3>
            ...
            {currentQuestion?.options.map((option, index) => (
              ...
              >
                <div className="flex items-center">
                  ...
                  {isSubmitted && (
                    index === currentQuestion.correctAnswer ? (
                      <svg className="w-5 h-5 ml-auto text-[#58c896]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M20 6 9 17l-5-5" />
                      </svg>
                    ) : selectedOption === index ? (
                      <svg className="w-5 h-5 ml-auto text-[#ff5e7d]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M18 6 6 18" />
                        <path d="m6 6 12 12" />
                      </svg>
                    ) : null
        ...
        <div className="flex justify-between">
          {!isSubmitted ? (
            ...
            >
              {currentQuiz === quizzes.length - 1 ? "Complete Quiz" : "Next Question"}
            </button>
          )}
        </div>
      </div>
      ...
      {isSubmitted && (
        <div className={`p-4 ${selectedOption === currentQuestion?.correctAnswer ? 'bg-[#58c896]/10' : 'bg-[#ff5e7d]/10'}`}>
            ...
            {selectedOption === currentQuestion?.correctAnswer ? (
              <>
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Great job! {currentQuestion?.xpReward} XP has been added to your account.
                    {correctStreak > 1 && ` +${Math.min(correctStreak, 5) * 2} bonus XP for your streak of ${correctStreak}!`}
                  </p>
              ...
              <>
                <div className="h-6 w-6 rounded-full bg-[#ff5e7d]/20 flex items-center justify-center mr-3 flex-shrink-0">
                  <svg className="w-4 h-4 text-[#ff5e7d]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M18 6 6 18" />
                    <path d="m6 6 12 12" />
                  </svg>
                </div>
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    The correct answer is option {String.fromCharCode(65 + currentQuestion?.correctAnswer)}: {currentQuestion?.options[currentQuestion.correctAnswer]}
                  </p>
                  {hearts <= 1 ? (
                    <p className="text-[#ff5e7d] text-sm font-medium mt-2">
                      You lost your last heart! Be careful with your next answers.
                    </p>
                  ) : (
