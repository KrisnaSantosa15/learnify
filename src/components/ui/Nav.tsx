  ...
  return (
    <header
      ...
      className={`fixed top-0 left-0 w-full transition-all duration-300 ${
        isScrolled ? "py-3 bg-[rgba(10,10,10,0.8)] backdrop-blur-md" : "py-5"
      }`}
    >
        ...
        <div className="flex justify-between items-center">
          ...
          <Link href="/" className="flex items-center">
            <span className="text-2xl font-bold">
              <span className="text-[#28c7f9]">Lernify</span>
          ...
          <button
            className="lg:hidden text-white hover:text-[#28c7f9] transition-colors duration-300"
