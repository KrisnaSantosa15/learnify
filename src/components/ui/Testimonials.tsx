...
function TestimonialCard({
  ...
  return (
    <div className="bg-[#151f38] rounded-xl border border-white/10 p-6 relative h-full flex flex-col">
      {/* Glowing accent */}
      <div
        className="absolute -top-3 -left-3 w-12 h-12 rounded-lg"
        style={{
      ...
      {/* Quote */}
      <div className="text-[#a8b1c2] mb-6 flex-1 text-lg leading-relaxed">
        {quote}
      </div>
      ...
      <div className="flex items-center">
        <div
          className="w-12 h-12 rounded-full overflow-hidden border-2 flex items-center justify-center bg-[#131d33]"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="max-w-2xl mx-auto text-[#a8b1c2] text-lg">
            Thousands of developers have transformed their learning journey with
            our platform. Here&apos;s what they&apos;re saying about Learnify.
          </p>
        </div>
              ...
              {testimonials.map((_, index) => (
                <button
                  ...
                  className={`w-2.5 h-2.5 rounded-full transition-colors ${
                    currentIndex === index ? "bg-[#8e5ff5]" : "bg-[#2a3a5a]"
                  }`}
        ...
        >
          <div className="bg-[#151f38] rounded-xl border border-white/10 p-6 text-center relative overflow-hidden group hover:border-[#28c7f9]/50 transition-colors">
            ...
            <div className="text-3xl md:text-4xl font-bold text-[#28c7f9] mb-1">
              98%
            </div>
          ...
          <div className="bg-[#151f38] rounded-xl border border-white/10 p-6 text-center relative overflow-hidden group hover:border-[#8e5ff5]/50 transition-colors">
            ...
            <div className="text-3xl md:text-4xl font-bold text-[#8e5ff5] mb-1">
              12K+
            </div>
          ...
          <div className="bg-[#151f38] rounded-xl border border-white/10 p-6 text-center relative overflow-hidden group hover:border-[#ff5e7d]/50 transition-colors">
            ...
            <div className="text-3xl md:text-4xl font-bold text-[#ff5e7d] mb-1">
              4.9
            </div>
          ...
          <div className="bg-[#151f38] rounded-xl border border-white/10 p-6 text-center relative overflow-hidden group hover:border-[#58c896]/50 transition-colors">
            ...
            <div className="text-3xl md:text-4xl font-bold text-[#58c896] mb-1">
              89%
            </div>
        ...
        >
          <p className="text-[#a8b1c2] mb-6 max-w-2xl mx-auto">
            Join thousands of satisfied learners and start your programming
            journey today. Get access to our full learning platform and
            community.
          </p>
          <a
            href="/signup"
