        ...
        <div className="absolute inset-0">
          <div
            ...
            style={{
              ...
              left: "8%",
              background:
                "radial-gradient(circle at center, #58c896 0%, transparent 70%)",
          ...
          <div
            ...
            style={{
              ...
              left: "20%",
              background:
                "radial-gradient(circle at center, #8e5ff5 0%, transparent 70%)",
          ...
          <div
            ...
            style={{
              ...
              right: "10%",
              background:
                "radial-gradient(circle at center, #28c7f9 0%, transparent 70%)",
      ...
      >
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
            ...
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#28c7f9] to-[#58c896]">
              For Modern Developers
            </span>
          </h2>
          <p className="text-lg text-[#a8b1c2] mb-8">
            Our platform offers interactive tools and challenges that transform
            how you learn to code, with real-time feedback and engaging
            experiences designed for today&apos;s developers.
          </p>

          {/* Stats row */}
          <div className="grid grid-cols-3 gap-4 max-w-lg mx-auto">
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4 text-center">
              <div className="text-xl sm:text-2xl text-[#28c7f9] font-bold mb-1">
                150+
              </div>
              <div className="text-xs text-[#a8b1c2]">Challenges</div>
            </div>
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4 text-center">
              <div className="text-xl sm:text-2xl text-[#58c896] font-bold mb-1">
                12
              </div>
              <div className="text-xs text-[#a8b1c2]">Languages</div>
            </div>
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4 text-center">
              <div className="text-xl sm:text-2xl text-[#8e5ff5] font-bold mb-1">
                98%
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="p-8 lg:p-10">
              ...
              <p className="text-lg text-[#a8b1c2] mb-6">
                Write, run, and debug code directly in your browser with
                real-time feedback. Our intelligent code editor provides hints,
                error checking, and auto-completion to accelerate your learning.
              </p>
              <ul className="space-y-3 mb-8">
                {[
                  ...
                  <li
                    key={i}
                    className="flex items-center text-[#a8b1c2] group"
                  >
              ...
              <Link
                href="/editor"
                className="px-6 py-3 bg-[#28c7f9] rounded-full text-white font-medium transition-all duration-300 flex items-center w-fit relative overflow-hidden group"
              >
            ...
            <div className="relative p-6 flex items-center justify-center bg-[#131d33]">
              ...
              <div className="w-full">
                <div className="bg-[#0d1525] rounded-t-lg p-3 flex items-center">
                  ...
                  <div className="mx-auto text-xs text-[#8b949e]">
                  ...
                  <div className="flex">
                    ...
                    <div className="flex-1 text-[#e6edf3]">
                      <div>
                        ...
                        <span className="text-[#d2a8ff]">solveChallenge</span>
                        (userInput) {"{"}
                      </div>
                      <div>
                        {" "}
                        <span className="text-[#ff7b72]">const</span> parsed ={" "}
                      ...
                      <div className="relative">
                        ...
                        <span className="text-[#ff7b72] relative"> for</span>
                        <span className="relative"> (</span>
                        <span className="text-[#ff7b72] relative">const</span>
                        <span className="relative"> item </span>
                        <span className="text-[#ff7b72] relative">of</span>
                        <span className="relative"> parsed) {"{"}</span>
                      </div>
                      <div className="relative">
                        <div className="absolute left-0 right-0 h-6 bg-[#28c7f9]/10 border-l-2 border-[#28c7f9]"></div>
                        <span className="relative"> </span>
                        <span className="text-[#ff7b72] relative">if</span>
                        <span className="relative"> (item.score {">"} </span>
                        <span className="text-[#79c0ff] relative">80</span>
                        <span className="relative">) {"{"}</span>
                      </div>
                      <div className="relative">
                        <div className="absolute left-0 right-0 h-6 bg-[#28c7f9]/10 border-l-2 border-[#28c7f9]"></div>
                        <span className="relative"> result.</span>
                        <span className="text-[#d2a8ff] relative">push</span>
                        <span className="relative">(item);</span>
                      </div>
                      <div className="relative">
                        <div className="absolute left-0 right-0 h-6 bg-[#28c7f9]/10 border-l-2 border-[#28c7f9]"></div>
                      ...
                      <div>
                        {" "}
                        <span className="text-[#ff7b72]">return</span> result;
                      </div>
                      <div>{"}"}</div>
                    </div>
                  </div>
                ...
                <div className="bg-[#0d1525] mt-2 p-3 rounded-lg border-t border-[#30363d]">
                  ...
                  <div className="text-[#e6edf3] text-xs font-mono">
                    <div>
                      <span className="text-[#58c896]">✓</span> Tests passed:{" "}
                      <span className="text-[#58c896]">5/7</span>
                    </div>
                    <div className="text-[#ff5e7d]">
              ...
              <div className="absolute -top-4 -right-4 bg-[#131d33]/90 backdrop-blur-sm p-3 rounded-lg border border-[#28c7f9]/30 shadow-lg shadow-[#28c7f9]/10 transform rotate-3">
                <div className="flex items-center gap-2 text-sm">
                  <svg
                    className="h-5 w-5 text-[#28c7f9]"
                    viewBox="0 0 20 20"
                    fill="currentColor"
                  >
                    <path
                      fillRule="evenodd"
                      d="M12 7a1 1 0 110-2h5a1 1 0 011 1v5a1 1 0 11-2 0V8.414l-4.293 4.293a1 1 0 01-1.414 0L8 10.414 7.293 11H12z"
                      clipRule="evenodd"
                    />
                  </svg>
