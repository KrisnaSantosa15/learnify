  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e: MouseEvent) => {
      ...
      elements.forEach((element, i) => {
        ...
        htmlElement.style.transform = `translate(${moveX}px, ${moveY}px) scale(${
          1 + depth * 0.1
        })`;
      });
    };
        ...
        <div className="absolute inset-0">
          ...
          <div
            ...
            style={{
              ...
              right: "25%",
              background:
                "radial-gradient(circle at center, #ff5e7d 0%, transparent 70%)",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-[#a8b1c2] text-lg mb-8 leading-relaxed">
              Master programming skills through interactive challenges, earn
              achievements as you progress, and join a community of learners in
              a dynamic, engaging environment designed for both beginners and
              experienced coders.
            </p>
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4 text-center">
                <div className="text-2xl text-[#28c7f9] font-bold mb-1">
                  {animatedCount.toLocaleString()}+
                </div>
                <div className="text-xs text-[#a8b1c2]">Learners</div>
              </div>
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4 text-center">
                <div className="text-2xl text-[#58c896] font-bold mb-1">
                  150+
                </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4 transition-all hover:border-[#28c7f9]/50 hover:bg-[#28c7f9]/5">
                ...
                <p className="text-[#a8b1c2] text-sm">
              ...
              <div className="bg-[#151f38]/80 backdrop-blur-sm rounded-2xl overflow-hidden border border-white/10 shadow-2xl shadow-[#28c7f9]/10">
                ...
                <div className="bg-[#131d33] p-4 flex items-center justify-between">
                  ...
                  <div className="flex items-center bg-[#1c2841] rounded-md px-3 py-1.5">
                    <svg
                      className="w-4 h-4 text-[#717d96] mr-2"
                      viewBox="0 0 20 20"
                      fill="currentColor"
                    >
                      <path
                    ...
                    <span className="text-[#717d96] text-xs">
                ...
                <div className="grid grid-cols-6 gap-0 text-sm">
                  ...
                  <div className="col-span-5 bg-[#151f38] py-4 pl-2 pr-4 text-left font-mono text-sm overflow-hidden">
                    <div>
                      <span className="text-[#8e5ff5]">function</span>{" "}
                      <span className="text-[#28c7f9]">calculateFactorial</span>
                      (<span className="text-[#ff5e7d]">n</span>) {"{"}
                    </div>
                    <div className="pl-4">
                      <span className="text-[#8e5ff5]">if</span> (n{" "}
                      <span className="text-[#58c896]">&lt;=</span>{" "}
                      <span className="text-[#fab72b]">1</span>) {"{"}
                    </div>
                    <div className="pl-8">
                      <span className="text-[#8e5ff5]">return</span>{" "}
                      <span className="text-[#fab72b]">1</span>;
                    </div>
                    <div className="pl-4">{"}"}</div>
                    <div className="pl-4">
                      <span className="text-[#8e5ff5]">return</span> n{" "}
                      <span className="text-[#58c896]">*</span>{" "}
                      <span className="text-[#28c7f9]">calculateFactorial</span>
                      (n <span className="text-[#58c896]">-</span>{" "}
                      <span className="text-[#fab72b]">1</span>);
                    </div>
                    <div>{"}"}</div>
                    <div></div>
                    <div>
                      <span className="text-[#6a7a95]">
                        {/* TODO: Implement the Fibonacci function */}
                      </span>
                    </div>
                    <div>
                      <span className="text-[#8e5ff5]">function</span>{" "}
                      <span className="text-[#28c7f9]">fibonacci</span>(
                      <span className="text-[#ff5e7d]">n</span>) {"{"}
                    </div>
                ...
                <div className="bg-[#131d33] p-4">
                  <div className="bg-[#0c1625] p-3 rounded-md">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <div className="flex items-center space-x-2">
                        <div className="text-xs bg-[#0b2d1a] text-[#58c896] px-2 py-0.5 rounded-md">
                          PASS
                        </div>
                        <div className="text-xs bg-[#1c2841] text-[#28c7f9] px-2 py-0.5 rounded-md">
                          Run
                        </div>
                      </div>
                    </div>
